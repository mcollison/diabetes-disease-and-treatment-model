function [pvalue, string_answers, h2, hs2] = generateBoxPlotsAndAnovaPValue(variableIndex, mcategory, metaboliteName, logswitch, groups)
h2=figure
...
for i=1:length(variableIndex)
    ...
    if logswitch(i)==0
        ...
        hs2 = subplot(1,length(variableIndex),i)
        h = boxplot(data);
        Xt = 1:length(groups);
