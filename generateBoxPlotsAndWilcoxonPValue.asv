...
for i=1:length(variableIndex)
    ...
    disp(strcat('independent t-test p-value for', {' '}, metaboliteName(variableIndex(i)), {' '}, 'between the', {' '}, mcategory{1,1}, {' '}, 'group and the', {' '}, mcategory{2,1}, {' '}, 'group: ', {' '}, num2str(pvalue(i))));
