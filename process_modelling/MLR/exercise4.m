%% Multiple linear regression modelling exercise 4
clear all 
close all 
randn('seed',0)
...
%% Exercise 3 extended to include noise parameter 
% Simulate model predictor variables and response variable

%generate 200x5 matrix of normal random numbers mean 0 sd 1
x=randn(100,2);
xn=x+xnoise*randn(100,2);%add noise to predictor variables 
%define beta values 
B0=0.5;
B1=-0.8;
B2=1.5;
n=ynoise*randn(100,1); %resposne noise
